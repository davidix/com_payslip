...
<td style="">
<?php 
_p('جمع حكم','جمع حكم متعلقه',$Values); 
_p('مبلغ اضافه كاري','مبلغ اضافه كاري',$Values); 
_p('بهره وري','ف - بهره وري',$Values); 
_p('اياب و ذهاب','اياب و ذهاب',$Values); 
_p('مبلغ  حق ماموريت','مبلغ  حق ماموريت',$Values); 
_p('ساير مزايا','ساير مزايا',$Values); 
_p('هزينه غذا','هزينه غذا',$Values); 
_p('سرويس','حق سرويس',$Values); 
_p('تفاوت حقوق','تفاوت حقوق',$Values); 
_p('آبونمان تلفن همراه','متعلقه پرداختي - آبونمان تلفن همراه',$Values); 
_p('تعطيل كاري','مبلغ تعطيل كاري',$Values); 
_p('مزاياي ٢','بستانكاران سنوات',$Values); 
...
<td style="">
<?php
_p('ماليات','ماليات جدول',$Values); 
_p('بيمه 7% سهم كارمند','بيمه 7% سهم كارمند',$Values); 
_p('بيمه حوادث ايران','متعلقه بيمه حوادث ايران',$Values); 
_p('بيمه عمر ايران','متعلقه بيمه عمر ايران',$Values); 
_p('بيمه تکميلي کارکنان','بيمه تکميلي کارکنان ثابت',$Values); 
_p('مساعده','مساعده',$Values); 
_p('صندوق مشاركت (1)','صندوق مشاركت (1)',$Values); 
//_p('بیمه تکمیلی ک موقت','بیمه تکمیلی ک موقت',$Values); 
_p('تلفن همراه','تلفن همراه',$Values); 
_p('صندوق مشاركت (2)','صندوق مشاركت (2)',$Values); 
...
<td style="">
<?php 
_pLoans('وام قرض الحسنه','وام قرض الحسنه',$Values); 
_pLoans('جاري','جاري',$Values); 
_pLoans('خسارت','خسارت',$Values); 
_pLoans('سرمايه','سرمايه',$Values); 
_pLoans('تعاوني مصرف','تعاوني مصرف',$Values); 
_pLoans('تعاوني اعتبار نصر','تعاوني اعتبار نصر',$Values); 
_pLoans('کسور دادگاهي','کسور  دادگاهي',$Values); 
_pLoans('جاري اقساطي خريد','جاري اقساطي خريد',$Values); 

_p('پس انداز','پس انداز',$Values); 
_p('جمع پس انداز','جمع پس انداز',$Values);
