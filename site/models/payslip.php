...
/**
 * Item Model for payslip.
 *
 * @package     Payslip
 * @subpackage  Models
 */
class PayslipModelPayslip extends JModelAdmin
{
	public function getUser_prsnno()
	{
	 ...
	 * @since   1.6
	 */
	protected $text_prefix = 'COM_PAYSLIP';
	 ...
	 * @since    3.2
	 */
	public $typeAlias = 'com_payslip.payslip';
	 ...
	 */
	public function getTable($type = 'Payslip', $prefix = 'PayslipTable', $config = array())
	{
	...
	public function getItem($pk = null)
	{
		...
		if($item->prs_no != $this->getUser_prsnno())
		{$item=null;}
		return $item;
	}
	...
	public function hit($pk = 0)
	{
		...
		if ($hitcount)
		{
			$pk = (!empty($pk)) ? $pk : (int) $this->getState('payslip.id');
